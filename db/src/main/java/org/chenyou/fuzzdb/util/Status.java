...
public class Status {
    ...
    static public Status NotFound(final Slice msg) {
        Slice msg2 = new Slice("");
        return NotFound(msg, msg2);
    }
    static public Status NotFound(final Slice msg, final Slice msg2) {
        return new Status(Code.kNotFound, msg, msg2);
    }

    static public Status Corruption(final Slice msg) {
        Slice msg2 = new Slice("");
        return Corruption(msg, msg2);
    }
    ...
    private Status(Code code, final Slice msg, final Slice msg2) {
        ...
        if(msg2 != null && !msg2.toString().equals("")) {
            sb.append(":");
